...
global loading
loading = image.load("stages/loading.jpg")


def loadimages():
    global loading
    screen.blit(transform.scale(loading,(1024,720)),(0,0))
    ...
    WIN = 10
    PROJ = 11
    global mugshots,vs,qmark,texts,menus
    ...
    qmark = image.load("icons/qmark.png")
    ...
    menu0,menu1,menu2 = [image.load("stages/title.png"),image.load("stages/select.png"),image.load("stages/instructions.png")]
...
player1 = [True,True,False,False,True,False,False,False,False,100,True]
player2 = [False,True,False,False,True,False,False,False,False,100,True]
...
if player1[CHAR] == "bison": p1hitbox = [700,670-89,0,0]
else: p1hitbox = [300,670-89,0,0]
p1hit = Rect(p1hitbox)

if player2[CHAR] == "bison": p2hitbox = [700,670-89,0,0]
...
global outleft,outright,score,menuscreen
outleft = Rect(1024,0,100,1024)
outright = Rect(-100,0,100,1024)

score = [1,1]

global menuscreen,selectrect,insrect,menurect,ryuselect,kenselect,bisonselect,select,canclick,stage1rect,stage2rect,stage3rect,stage,startrect
menuscreen = "menu"
...
selectrect = Rect(265,475,495,50)
insrect = Rect(165,555,695,60)
menurect = Rect(0,0,100,100)
ryuselect = Rect(325,225,85,120)
kenselect = Rect(460,225,85,120)
bisonselect = Rect(600,225,85,120)

stage1rect = Rect(30,489,295,168)
stage2rect = Rect(362,489,301,168)
stage3rect = Rect(697,489,297,168)
startrect = Rect(430,388,150,50)
...
def chargeAttp1():
    ...
    if player1[CANATT] == True and player1[ONGROUND] == True and keys[ord("h")] == 1:
    ...
    if keys[ord("h")] == 0 and p1frames[ANI] == "special":
        player1[MOVING] = False
        p1frames[ANI] = "idle"
        p1frames[NUM] = 0
        player1[DAMAGE] = False
...
def attp1():
    ...
    if player1[CANATT] == True and player1[ONGROUND] == True and keys[ord("f")] == 1 and player1[CHAR] == "ryu":
    ...
    if player1[CANATT] == True and player1[ONGROUND] == True and keys[ord("g")] == 1 and player1[CHAR] == "ryu":
    ...
    if player1[CANATT] == True and player1[ONGROUND] == False and keys[ord("f")] == 1 and player1[CHAR] == "ryu":
    ...
    if player1[CANATT] == True and player1[ONGROUND] == False and keys[ord("g")] == 1 and player1[CHAR] == "ryu":
    ...
    if player1[CANATT] == True and player1[ONGROUND] == True and keys[ord("f")] == 1 and player1[CHAR] == "ken":
    ...
    if player1[CANATT] == True and player1[ONGROUND] == True and keys[ord("g")] == 1 and player1[CHAR] == "ken":
    ...
    if player1[CANATT] == True and player1[ONGROUND] == False and keys[ord("f")] == 1 and player1[CHAR] == "ken":
    ...
    if player1[CANATT] == True and player1[ONGROUND] == False and keys[ord("g")] == 1 and player1[CHAR] == "ken":
    ...
    if player1[CANATT] == True and player1[ONGROUND] == True and keys[ord("f")] == 1 and player1[CHAR] == "bison":
    ...
    if player1[CANATT] == True and player1[ONGROUND] == True and keys[ord("g")] == 1 and player1[CHAR] == "bison":
    ...
    if player1[CANATT] == True and player1[ONGROUND] == False and keys[ord("f")] == 1 and player1[CHAR] == "bison":
    ...
    if player1[CANATT] == True and player1[ONGROUND] == False and keys[ord("g")] == 1 and player1[CHAR] == "bison":
...
def drawScene():
    if stage == 1: screen.blit(stages[0],(0,0))
    if stage == 2: screen.blit(stages[1],(0,0))
    if stage == 3: screen.blit(stages[2],(0,0))
...
def menu():
    global menuscreen,select,canclick,stage,score
    if menuscreen == "menu":
        screen.blit(menus[0],(0,0))

        if mb[0] == 1 and selectrect.collidepoint((mx,my)):
            menuscreen = "select"
        elif mb[0] == 1 and insrect.collidepoint((mx,my)):
            menuscreen = "ins"

    if menuscreen == "ins":
        screen.blit(menus[2],(0,0))

        if mb[0] == 1 and menurect.collidepoint((mx,my)):
            menuscreen = "menu"



    if menuscreen == "select":
        screen.blit(menus[1],(0,0))

        if mb[0] == 1 and menurect.collidepoint((mx,my)):
            player1[CHAR],player2[CHAR],select = False,False,1
            menuscreen = "menu"

        if mb[0] == 1 and ryuselect.collidepoint((mx,my)) and canclick == True:
            if select == 1:
                player1[CHAR] = "ryu"
                select = 2
                canclick = False
        ...
        if mb[0] == 1 and kenselect.collidepoint((mx,my)) and canclick == True:
            if select == 1:
                player1[CHAR] = "ken"
                select = 2
                canclick = False
        ...
        if mb[0] == 1 and bisonselect.collidepoint((mx,my)) and canclick == True:
            if select == 1:
                player1[CHAR] = "bison"
                select = 2
                canclick = False
        ...
        if mb[0] == 1 and startrect.collidepoint((mx,my)):
            score = [0,0]
            if player1[CHAR] == False:
                num = randint(1,3)
                if num == 1: player1[CHAR] = "ryu"
                elif num == 2: player1[CHAR] = "ken"
                elif num == 3: player1[CHAR] = "bison"
            if player2[CHAR] == False:
                num = randint(1,3)
                if num == 1: player2[CHAR] = "ryu"
                elif num == 2: player2[CHAR] = "ken"
                elif num == 3: player2[CHAR] = "bison"
            menuscreen = False
            screen.blit(transform.scale(loading,(1024,720)),(0,0))
            loadimages()
        ...
        if canclick == False and mb[0] == False: canclick = True

        if mb[0] == 1 and stage1rect.collidepoint((mx,my)): stage = 1
        if mb[0] == 1 and stage2rect.collidepoint((mx,my)): stage = 2
        if mb[0] == 1 and stage3rect.collidepoint((mx,my)): stage = 3

        if stage == 1: draw.rect(screen,(255,0,0),stage1rect,3)
        if stage == 2: draw.rect(screen,(255,0,0),stage2rect,3)
        if stage == 3: draw.rect(screen,(255,0,0),stage3rect,3)

        if player1[CHAR] == False: screen.blit(transform.scale(qmark,(200,300)),(45,75))
        if player1[CHAR] == "ryu": screen.blit(transform.scale(mugshots[0],(200,300)),(50,75))
        if player1[CHAR] == "ken": screen.blit(transform.scale(mugshots[1],(200,300)),(45,75))
        if player1[CHAR] == "bison": screen.blit(transform.scale(mugshots[2],(200,300)),(45,75))

        if player2[CHAR] == False: screen.blit(transform.scale(qmark,(200,300)),(785,75))
        if player2[CHAR] == "ryu": screen.blit(transform.scale(mugshots[0],(200,300)),(785,75))
        if player2[CHAR] == "ken": screen.blit(transform.scale(mugshots[1],(200,300)),(785,75))
        if player2[CHAR] == "bison": screen.blit(transform.scale(mugshots[2],(200,300)),(785,75))
...
def restart():
    ...
    global player1,player2,p1hitbox,p1attbox,attack1,attack2,p1sprite,waiting,waittime

    player1 = [True,True,False,False,True,False,False,False,False,100,True]
    player2 = [False,True,False,False,True,False,False,False,False,100,True]


    p1hitbox = [700,670-89,0,0]
    p1hit = Rect(p1hitbox)

    p2hitbox = [700,670-89,0,0]
    p2hit = Rect(p2hitbox)
